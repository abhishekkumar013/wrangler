...
This enhancement adds support for parsing and utilizing byte size and time duration units within recipes.

### Byte Size Parser

Supports units like B, KB, MB, GB, TB, PB. Examples:
...
Supports units like ns, ms, s, m, h, d. Examples:
...
A new directive for aggregating byte sizes and time durations:
**NLP** | |
